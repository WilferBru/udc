...
{ ?>
    ...
    <body id="page-top">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input type="text" class="form-control bg-light border-0 small" placeholder="Buscar encuesta..." aria-label="Search" aria-describedby="basic-addon2">
        ...
        if (isset($_REQUEST['toast']) && $_REQUEST['toast']==1 ){
            ...
            <script>
                Command: toastr["success"]("La Encuesta Ha Sido Actualizada Exitosamente", "Encuesta Actualizada")
