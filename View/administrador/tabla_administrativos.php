    ...
    <div id="wrapper">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="?a=tablaAdministrativos">Tabla de Administrativos</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Consulta de Administrativos en la Base de Datos</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                    $num = 0;
                                    foreach($this->model->tablaAdministrativos() as $r): $num++; ?>
                                        <tr>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a class="btn btn-danger" href="?a=eliminarAdministrativo&identificacion=<?=$r->identificacion?>">Eliminar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="?a=agregarAdministrativo" method="post">
        ...
        <?php
            if (isset($_REQUEST['toast']) && $_REQUEST['toast']==1 ){
                ...
                <script>
                    Command: toastr["success"]("El registro ha sido eliminado exitosamente", "Administrativo Eliminado")
            ...
            ?>
                ...
                <script>
                    Command: toastr["success"]("El registro ha sido agregado exitosamente", "Administrativo Agregado")
            ...
            ?>
                ...
                <script>
                    Command: toastr["error"]("Por favor, rellene todos los campos", "Error al Agregar al Administrativo")
