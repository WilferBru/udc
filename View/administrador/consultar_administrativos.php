...
{ ?>
    ...
    <div id="wrapper">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="?a=consultarAdministrativos">Consultar Administrativos</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Consulta de Administrativos de UdC+</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    $num = 0;
                                    foreach($this->model->consultarAdministrativos() as $r): $num++ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a  class="btn btn-primary" href="#" data-toggle="modal" data-target="#Visualizar<?=$num?>">Visualizar</a>
                                        ...
                                        <div class="modal fade" id="Eliminar<?=$num?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">¿Estas seguro de eliminar este estudiante de UdC+?<br> Una vez Eliminado no podras recuperarlo.</div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                                                        <a class="btn btn-danger" href="?a=eliminarUsuario&identificacion=<?=$r->identificacion?>">Eliminar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="modal fade" id="Visualizar<?=$num?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" class="form-control" value="<?=$r->lastName?>" readonly>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" class="form-control" value="<?=$r->identificacion?>" readonly>
                                                            </div>
                                                            <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" class="form-control" value="<?=$r->encuesta?>" readonly>
                                                            </div>
                                                        </div>
        ...
        if (isset($_REQUEST['toast']) && $_REQUEST['toast']==1 ){
            ...
            <script>
                Command: toastr["success"]("El registro ha sido eliminado satisfactoriamente", "Registro Eliminado")
