        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Consulta de Encuestas Realizadas</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach($this->model->consultarEncuesta() as $r): ?>
                                        <tr>
                                            <td><?php echo $r->identificacion; ?></td>
                                            <td><?php echo $r->name; ?></td>
                                            <td><?php echo $r->lastName; ?></td>
                                            <td><?php echo $r->encuesta; ?></td>

                                            <td>
                                                <a  class="btn btn-primary" href="?a=visualizarEncuesta&id=<?=$r->encuesta?>">Visualizar</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
